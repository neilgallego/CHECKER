...
<div style="position:absolute; right:8%; top: 2.5%;">
    <input id="TABLES" type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModalassign" onclick="showDiv();" style="background-color:#CD5C5C;color:#FFF;border-color:#CD5C5C; top:0%;" value="Assign Waiters">
