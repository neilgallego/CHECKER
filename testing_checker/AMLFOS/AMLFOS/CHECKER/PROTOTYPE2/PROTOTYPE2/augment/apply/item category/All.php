...
<?php
	...
	$product_array = $db_handle->runQuery("SELECT menuitem_id, item_category, name, item_happyprice, item_availability, code FROM menu_db where code  LIKE '%".$_POST["term"]."%' OR name LIKE '%".$_POST["term"]."%'");
